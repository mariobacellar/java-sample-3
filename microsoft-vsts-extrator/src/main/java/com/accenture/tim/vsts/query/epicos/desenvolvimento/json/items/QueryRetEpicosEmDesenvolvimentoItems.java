package com.accenture.tim.vsts.query.epicos.desenvolvimento.json.items;
 ...
 *
 */
public class QueryRetEpicosEmDesenvolvimentoItems implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if ((other instanceof QueryRetEpicosEmDesenvolvimentoItems) == false) {
			return false;
		}
		QueryRetEpicosEmDesenvolvimentoItems rhs = ((QueryRetEpicosEmDesenvolvimentoItems) other);
